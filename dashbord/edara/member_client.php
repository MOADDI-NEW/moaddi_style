...
if (isset($_SESSION['Edara30'])){
    $pageTitle = 'صفحة اعضاء الشركات ';  // this function to load page title
				...
				if (! empty($rows)){ ?>
					<div class="container-fluid">
						<div class="row row-sm">
							<div class="col-lg-12">
								<div class="card">
									<div class="card-header"><h3 class="card-title text-center">قوائم الأعضاء  - شركة</h3></div>
											<?php
												if (isset($_SESSION['Edara30'])){
													$getUser = $con->prepare("SELECT * FROM users WHERE Username = ?");
													$getUser->execute(array($_SESSION['Edara30']));
						...
						echo '<a href="member_client?do=Add" class="btn btn-primary"><i class="fa fa-plus"></i> اضافة شركة جديد </a>';
					echo '</div>';  } 
			}
			...
			if (array_search($info['GroupID'], ['1']) !== false) { // المدير  ?>
					<div class="container-fluid">
						<div class="row row-sm">
							<div class="col-lg-12">
									<div class="card">
										<div class="card-header"><h3 class="card-title text-center">اضافة شركة جديد</h3></div>
										<div class="card-body">
